...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RockermqStorage) DeepCopyInto(out *RockermqStorage) {
	*out = *in
	out.Size = in.Size.DeepCopy()
	if in.PVDistribution != nil {
		in, out := &in.PVDistribution, &out.PVDistribution
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RockermqStorage.
func (in *RockermqStorage) DeepCopy() *RockermqStorage {
	if in == nil {
		return nil
	}
	out := new(RockermqStorage)
